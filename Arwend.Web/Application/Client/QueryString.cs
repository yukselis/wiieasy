...
using System.Web;
namespace Arwend.Web.Application.Client
{
    public class QueryString
    {
        ...
        private string sScriptName = string.Empty;
        private string sRawUrl = string.Empty;
        ...
        public QueryString(HttpRequestBase Request)
            : this()
        {
