...
$('.daterangebar').daterangepicker(
    {
        format: 'll',
        opens: 'left',
        separator: ' - ',
        startDate: moment($(".startdate").val(), "DD.MM.YYYY HH:mm:ss"),
        endDate: moment($(".enddate").val(), "DD.MM.YYYY HH:mm:ss"),
        showCalendars: true,
    ...
    function (start, end) {
        $(".startdate").val(start.format('L'));
        $(".enddate").val(end.format('L'));
        $('.daterangebar span').html(start.format('ll') + ' - ' + end.format('ll'));
    }
);
