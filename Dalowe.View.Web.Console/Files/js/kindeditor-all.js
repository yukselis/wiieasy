...
K.basePath = "/Files/Images/KindEditor/";
K.options = {
	designMode : true,
	...
	zIndex : 811213,
	items : [
		'source', 'preview', '|', 'plainpaste', 'wordpaste', '|', 'justifyleft', 'justifycenter', 'justifyright',
		'justifyfull', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', '|', 
		'formatblock', 'fontsize', '|', 'forecolor', 'bold', 'italic', 'underline', '|', 'image', '|', 'link', 'unlink', 'fullscreen'
	],
	...
	colorTable : [
		...
		['#FFFFFF', '#CCCCCC', '#999999', '#333333', '#333333', '#000000']
	],
	...
	create : function() {
		...
		K.each(self.items, function(i, name) {
			if (name == '|') {
				...
				htmlList.push('<span class="ke-outline" data-name="' + name + '" title="' + self.lang(name) + '">');
				htmlList.push('<span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-' + name + '"></span></span>');
			}
		});
...
function _create(expr, options) {
	...
	options.themesPath = _undef(options.themesPath, '/Files/Themes');
	options.langPath = _undef(options.langPath, options.basePath + 'lang/');
	options.pluginsPath = _undef(options.pluginsPath, options.basePath + 'plugins/');
	if (_undef(options.loadStyleMode, K.options.loadStyleMode)) {
	    var themeType = _undef(options.themeType, K.options.themeType);
	    _loadStyle(options.themesPath + '/kindeditor-default-theme.css');
...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		uploadJson = K.undef(self.uploadJson, self.basePath + 'Ajax/UploadImage');
	self.plugin.flash = {
		edit : function() {
			var html = [
...
KindEditor.plugin('image', function(K) {
	var self = this, name = 'image',
		...
		formatUploadUrl = K.undef(self.formatUploadUrl, true),
		allowFileManager = K.undef(self.allowFileManager, false),
		uploadJson = K.undef(self.uploadJson, '/Ajax/UploadImage'),
		imageTabIndex = K.undef(self.imageTabIndex, 0),
		imgPath = '/Files/Images/KindEditor/',
		extraParams = K.undef(self.extraFileUploadParams, {}),
		filePostName = K.undef(self.filePostName, 'imgFile'),
...
KindEditor.plugin('insertfile', function(K) {
	var self = this, name = 'insertfile',
		...
		allowFileManager = K.undef(self.allowFileManager, false),
		formatUploadUrl = K.undef(self.formatUploadUrl, true),
		uploadJson = K.undef(self.uploadJson, self.basePath + '/Ajax/UploadFile'),
		extraParams = K.undef(self.extraFileUploadParams, {}),
		filePostName = K.undef(self.filePostName, 'imgFile'),
		lang = self.lang(name + '.');
...
KindEditor.plugin('media', function(K) {
	var self = this, name = 'media', lang = self.lang(name + '.'),
		...
		extraParams = K.undef(self.extraFileUploadParams, {}),
		filePostName = K.undef(self.filePostName, 'imgFile'),
		uploadJson = K.undef(self.uploadJson, self.basePath + '/Ajax/UploadMedia');
	self.plugin.media = {
		edit : function() {
			var html = [
				'<div style="padding:20px;">',
